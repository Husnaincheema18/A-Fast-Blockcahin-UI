...
const Hero = () => {
  return (
    ...
    <p className='w-[45%] text-milkwhite text-2xl font-light font-inter m-auto mt-14'>Bring blockchain to the people. Solana supports experiences for power users, new consumers, and everyone in between.</p>
